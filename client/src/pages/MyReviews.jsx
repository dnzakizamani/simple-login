...
import { FaStar, FaBook, FaUser, FaEdit, FaTrash } from 'react-icons/fa';
...
export default function MyReviews() {
  ...
  const fetchMyReviews = async () => {
    try {
      const response = await axios.get('http://localhost:4000/api/book-reviews/my-reviews', { withCredentials: true });
      ...
      <Layout title="My Reviews">
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Please log in</h3>
            <p className="text-gray-600 dark:text-gray-400">You need to be logged in to view your reviews.</p>
          </div>
        </div>
      </Layout>
    );
    ...
    <Layout title="My Reviews">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-light text-gray-900 dark:text-white mb-2">My Reviews</h1>
            <p className="text-gray-600 dark:text-gray-400">All the books you've reviewed</p>
          </div>
          <button
            onClick={() => {
        ...
        {reviews.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              You haven't written any reviews yet. Start by reviewing a book!
            </p>
          </div>
        ) : (
